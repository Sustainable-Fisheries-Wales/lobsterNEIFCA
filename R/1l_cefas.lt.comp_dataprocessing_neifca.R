# script for data cleaning for the crab and lobster length composition dataset (from CEFAS port sampling) - North Eastern IFCA
...
port.sampling_neifca.crab <- port.sampling_neifca |> 
  dplyr::filter(species == "CRE")

# # subset port sampling
# port.sampling_neifca.lobster_port <- port.sampling_neifca |> 
#   dplyr::filter(species == "LBE" & data_source == "Port")
# port.sampling_neifca.crab_port <- port.sampling_neifca |> 
#   dplyr::filter(species == "CRE" & data_source == "Port")
# 
# # subset onbord sampling
# port.sampling_neifca.lobster_boat <- port.sampling_neifca |> 
#   dplyr::filter(species == "LBE" & data_source == "Boat")
# port.sampling_neifca.crab_boat <- port.sampling_neifca |> 
...
readr::write_csv(port.sampling_neifca.crab, file = "processed_data/neifca/lt.comp_crab_neifca_clean.csv")
# readr::write_csv(port.sampling_neifca.lobster_port, file = "processed_data/neifca/lt.comp_lobster_neifca_port_clean.csv") 
# readr::write_csv(port.sampling_neifca.crab_port, file = "processed_data/neifca/lt.comp_crab_neifca_port_clean.csv")
# readr::write_csv(port.sampling_neifca.lobster_boat, file = "processed_data/neifca/lt.comp_lobster_neifca_boat_clean.csv") 
# readr::write_csv(port.sampling_neifca.crab_boat, file = "processed_data/neifca/lt.comp_crab_neifca_boat_clean.csv")
...
# crab
data <- port.sampling_neifca.crab
data$length <- data$length/10 # recorded in mm -> convert to cm for ss
size.min <- 1#round(min(data$length, na.rm = TRUE))) #10
size.max <- 27#round(max(data$length, na.rm = TRUE))) #23
width <- 0.2
n.size <- length(table(cut(data$length, breaks = c(size.min, 
...
readr::write_csv(size.dist_crab, file = "processed_data/neifca/size.comp.data_crab_neifca_ss.csv") 
...
# crab
data2 <- port.sampling_neifca.lobster
...
# export plot
ggplot2::ggsave(file="plots/neifca/size.comp_crab_neifca.svg", plot=plot2, width=12, height=8)
